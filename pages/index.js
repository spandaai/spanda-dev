           ...
           if(nftMarketWorkObject && nftMarketWorkObject){
            ...
            console.log(data)
               const items = await Promise.all(data.map(async item=>{
                ...
                const replaceIPFsName =  nftUrl.toString().replace("ipfs.infura.io","opensee.infura-ipfs.io")
            ...
            const replaceIPFsImageName =  oldImageUrl.toString().replace("ipfs.infura.io","opensee.infura-ipfs.io")
        ...
        <div className="bg-white shadow-2xl rounded-b-3xl">
          ...
          <div className="grid grid-cols-4 w-72 lg:w-5/6 m-auto bg-indigo-50 mt-5 p-4 lg:p-4 rounded-2xl">
            <div className="col-span-1 flex">
              ...
              <img className="flex justify-center w-15 lg:w-12" src="./bnb.png" alt="music icon"/>
            </div>
